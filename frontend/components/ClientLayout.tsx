...
const LayoutContent: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="flex h-screen bg-slate-950 text-slate-100 overflow-hidden font-sans relative">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] rounded-full bg-indigo-500/5 blur-[120px] pointer-events-none -z-10" />
      <div className="absolute bottom-[-10%] left-[20%] w-[400px] h-[400px] rounded-full bg-violet-500/5 blur-[100px] pointer-events-none -z-10" />

      <Sidebar />
      <div className="flex flex-col flex-1 overflow-hidden relative bg-grid-pattern">
        <Navbar />
